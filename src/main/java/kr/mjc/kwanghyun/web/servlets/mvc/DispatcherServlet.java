...
import kr.mjc.kwanghyun.web.dao.Subscribe;
...
public class DispatcherServlet extends HttpServlet {
  ...
  public void init() {
    ...
    subscribeController = wac.getBean(SubscribeController.class);
  }
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    switch (pathInfo) {
      ...
      case "/article/getArticle" -> articleController.getArticle(request, response);
      ...
      case "/subscribe/subscribeList" -> subscribeController.subscribeList(request, response);
